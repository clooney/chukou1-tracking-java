public class Test {
	...
	public static void main(String[] args) {
		try {
			...
			// String	urlStr ="/chukou1/6A15658403318";
			...
			// String	urlStr =null;
			// String requestData="{\"tracking_number\": \"6A15658403318\",\"carrier_code\":\"chukou1\",\"destination_code\":\"US\",\"tracking_ship_date\": \"20180908\",\"tracking_postal_code\":\"12201\",\"specialNumberDestination\":\"UK\",\"order\":\"#123\",\"order_create_time\":\"2018/09/08 16:51\",\"lang\":\"en\"}";
			// String result = new Tracker().orderOnlineByJson(requestData,urlStr,"realtime");
			// System.out.println("result======="+result);

			// 10 Modify courier code
			// String	urlStr =null;
			// String requestData="{\"tracking_number\": \"6A15658403318\",\"carrier_code\":\"chukou1\",\"update_carrier_code\":\"china-ems\"}";
			...
			// String	urlStr =null;
			// String requestData= "[{\"tracking_number\":\"6A15658403318\",\"carrier_code\":\"chukou1\"},{\"tracking_number\":\"LZ448865302CN\",\"carrier_code\":\"china-ems\"}]";
			...
			// String	urlStr =null;
			// String requestData= "[{\"carrier_code\":\"chukou1\",\"destination\":\"US\",\"original\":\"CN\"},{\"carrier_code\":\"china-ems\",\"destination\":\"US\",\"original\":\"CN\"}]";
